...
-- Generated: 2026-08-25 06:50:43 UTC
-- Author: devours@internet.ru

SET XACT_ABORT ON;
BEGIN TRANSACTION;

-- [1] Create new item: def_weasel_named4_core_recharger
DECLARE @mainDef INT;
INSERT INTO entitydefaults (definitionname, quantity, attributeflags, categoryflags, options, note, enabled, volume, mass, hidden, health, descriptiontoken, purchasable, tiertype, tierlevel) VALUES (N'def_weasel_named4_core_recharger', 1, 524288, 262927, N'#moduleFlag=i20
#ammoCapacity=i0
#powergrid_usage=f2.00
#cpu_usage=f29.00
#tier=$tierlevel_t5', N'', 1, 0.5, 95, 0, 100, N'def_weasel_named4_core_recharger_desc', 1, 1, 5);
